...
export const appRoutes: Route[] = [
    ...
    {path: '', pathMatch : 'full', redirectTo: 'finance/account'},
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'finance/account'},
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'dashboards', children: [
                {path: 'analytics', loadChildren: () => import('app/modules/scallop/dashboards/analytics/analytics.module').then(m => m.ProjectModule)},
                {path: 'project', loadChildren: () => import('app/modules/admin/dashboards/analytics/analytics.module').then(m => m.AnalyticsModule)},
                {path: 'finance', loadChildren: () => import('app/modules/scallop/dashboards/finance/finance.module').then(m => m.FinanceModule)},
                {path: 'crypto', loadChildren: () => import('app/modules/scallop/dashboards/crypto/crypto.module').then(m => m.CryptoModule)},
            ]},

            // web app
            {path: 'finance', children: [
                {path: 'account', loadChildren: () => import('app/modules/web-app/finance-dashboard/account/account.module').then(m => m.AccountModule)},
                {path: 'transaction', loadChildren: () => import('app/modules/web-app/finance-dashboard/transaction/transaction.module').then(m => m.TransactionModule)},
                {path: 'beneficiaries', loadChildren: () => import('app/modules/web-app/finance-dashboard/beneficiaries/contacts.module').then(m => m.ContactsModule)}
            ]},
            // web app setting
            {path: 'settings', children: [
                {path: 'settings', loadChildren: () => import('app/modules/web-app/settings/settings.module').then(m => m.SettingsModule)}
            ]},
            {path: 'crypto', children: [
                {path: 'market', loadChildren: () => import('app/modules/web-app/market/market/market.module').then(m => m.MarketModule)},
                {path: 'wallet', loadChildren: () => import('app/modules/web-app/market/wallet.module').then(m => m.TransactionModule)},
                {path: 'wallet/:type/:asset', loadChildren: () => import('app/modules/web-app/market/crypto/crypto.module').then(m => m.CryptoModule)},
                {path: 'swap', loadChildren: () => import('app/modules/web-app/market/swap/swap.module').then(m => m.SwapModule)}
            ]},

            // Apps
            {path: 'apps', children: [
                {path: 'CUSTOMER_MANAGEMENT', loadChildren: () => import('app/modules/scallop/apps/ecommerce/ecommerce.module').then(m => m.ECommerceModule)},
                {path: 'SECURITIES', loadChildren: () => import('app/modules/scallop/apps/security/security.module').then(m => m.SecurityModule)},
                {path: 'ROLE_MANAGEMENT', loadChildren: () => import('app/modules/scallop/apps/settings/settings.module').then(m => m.SettingsModule)},
