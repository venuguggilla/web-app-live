...
import { InventoryTag } from 'app/modules/scallop/apps/ecommerce/inventory/inventory.types';
      ...
      sendMoney(): Observable<any>
        {
            ...
            let url = 'https://api.scallopx.com/' + this._apiEndpoint.webApp.payment.send;
            url = url;
            return this._httpClient.post(url,this.newAccountDetails);
        }
    /**
     * Update contact
     *
